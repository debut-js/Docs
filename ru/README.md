 ...
 **(100$/месяц [Купить сейчас!](https://www.patreon.com/bePatron?u=57560983))**
...
__Описание:__ Массив свеч [Candle](#candle) (10 последних), `this.candles[0]` - текущая не закрытая свеча, `this.candles[1]` - предыдущая закрытая свеча.
